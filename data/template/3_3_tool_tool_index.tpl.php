<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('tool_index');?><?php include template('common/header'); ?><link rel="stylesheet" href="static/css/tools.css" />
   <style type="text/css">
.wp{width: auto;}
   </style>
    	...
    	<div class="tools_container">
    		<div class="tools_left">
    			...
    			<div class="tools_classify" >
    				<a class="tools_img" href="javascript:;">
    					<img src="static/image/tools/index.png">
    				</a>
