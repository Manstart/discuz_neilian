<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forumdisplay_56');
0
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_56.htm', './template/default/forum/forumdisplay_leftside.htm', 1509099436, 'diy', './data/template/3_diy_forum_forumdisplay_56.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_56')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_56.htm', './template/default/forum/recommend.htm', 1509099436, 'diy', './data/template/3_diy_forum_forumdisplay_56.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_56')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_56.htm', './template/default/common/seccheck.htm', 1509099436, 'diy', './data/template/3_diy_forum_forumdisplay_56.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_56')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_56.htm', './template/default/forum/forumdisplay_list.htm', 1509099436, 'diy', './data/template/3_diy_forum_forumdisplay_56.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_56')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_56.htm', './template/default/forum/forumdisplay_sort.htm', 1509099436, 'diy', './data/template/3_diy_forum_forumdisplay_56.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_56')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_56.htm', './template/default/forum/search_sortoption.htm', 1509099436, 'diy', './data/template/3_diy_forum_forumdisplay_56.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_56')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_56.htm', './template/default/forum/search_sortoption.htm', 1509099436, 'diy', './data/template/3_diy_forum_forumdisplay_56.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_56')
;?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<style id="diy_style" type="text/css"></style>
<!--[diy=diynavtop]--><div id="diynavtop" class="area"><div id="frameBMjQtE" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext" style="font-size:21px;margin-left:400px;color:rgb(0, 0, 255);"><a href="exam.php?mod=index&amp;action=exam_check">待审核的题库</a></span></div><div id="frameBMjQtE_left" class="column frame-1-c"><div id="frameBMjQtE_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
