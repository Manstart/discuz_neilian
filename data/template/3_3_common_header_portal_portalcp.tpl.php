...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1508915196, '3', './data/template/3_3_common_header_portal_portalcp.tpl.php', './template/PHPChina', 'common/header_portal_portalcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1508915196, '3', './data/template/3_3_common_header_portal_portalcp.tpl.php', './template/PHPChina', 'common/header_portal_portalcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1508915196, '3', './data/template/3_3_common_header_portal_portalcp.tpl.php', './template/PHPChina', 'common/header_portal_portalcp')
;?>
