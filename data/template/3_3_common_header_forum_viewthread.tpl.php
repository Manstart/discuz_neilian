...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1506400801, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/PHPChina', 'common/header_forum_viewthread')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1506400801, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/PHPChina', 'common/header_forum_viewthread')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1506400801, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/PHPChina', 'common/header_forum_viewthread')
;?>
