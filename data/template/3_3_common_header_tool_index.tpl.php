...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1508918135, '3', './data/template/3_3_common_header_tool_index.tpl.php', './template/PHPChina', 'common/header_tool_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1508918135, '3', './data/template/3_3_common_header_tool_index.tpl.php', './template/PHPChina', 'common/header_tool_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1508918135, '3', './data/template/3_3_common_header_tool_index.tpl.php', './template/PHPChina', 'common/header_tool_index')
;?>
