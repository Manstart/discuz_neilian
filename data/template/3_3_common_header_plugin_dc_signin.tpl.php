...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1508915076, '3', './data/template/3_3_common_header_plugin_dc_signin.tpl.php', './template/PHPChina', 'common/header_plugin_dc_signin')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1508915076, '3', './data/template/3_3_common_header_plugin_dc_signin.tpl.php', './template/PHPChina', 'common/header_plugin_dc_signin')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1508915076, '3', './data/template/3_3_common_header_plugin_dc_signin.tpl.php', './template/PHPChina', 'common/header_plugin_dc_signin')
;?>
