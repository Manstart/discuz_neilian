...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1506400880, '3', './data/template/3_3_common_header_misc_stat.tpl.php', './template/PHPChina', 'common/header_misc_stat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1506400880, '3', './data/template/3_3_common_header_misc_stat.tpl.php', './template/PHPChina', 'common/header_misc_stat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1506400880, '3', './data/template/3_3_common_header_misc_stat.tpl.php', './template/PHPChina', 'common/header_misc_stat')
;?>
