...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1509325674, '3', './data/template/3_3_common_header_home_spacecp.tpl.php', './template/PHPChina', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1509325674, '3', './data/template/3_3_common_header_home_spacecp.tpl.php', './template/PHPChina', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1509325674, '3', './data/template/3_3_common_header_home_spacecp.tpl.php', './template/PHPChina', 'common/header_home_spacecp')
;?>
