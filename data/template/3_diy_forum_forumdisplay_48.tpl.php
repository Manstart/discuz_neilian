<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forumdisplay_48');
0
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_48.htm', './template/default/forum/forumdisplay_leftside.htm', 1508916342, 'diy', './data/template/3_diy_forum_forumdisplay_48.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_48')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_48.htm', './template/default/forum/recommend.htm', 1508916342, 'diy', './data/template/3_diy_forum_forumdisplay_48.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_48')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_48.htm', './template/default/common/seccheck.htm', 1508916342, 'diy', './data/template/3_diy_forum_forumdisplay_48.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_48')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_48.htm', './template/default/forum/forumdisplay_list.htm', 1508916342, 'diy', './data/template/3_diy_forum_forumdisplay_48.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_48')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_48.htm', './template/default/forum/forumdisplay_sort.htm', 1508916342, 'diy', './data/template/3_diy_forum_forumdisplay_48.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_48')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_48.htm', './template/default/forum/search_sortoption.htm', 1508916342, 'diy', './data/template/3_diy_forum_forumdisplay_48.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_48')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_48.htm', './template/default/forum/search_sortoption.htm', 1508916342, 'diy', './data/template/3_diy_forum_forumdisplay_48.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_48')
...
<div class="drag">
<!--[diy=diy4]--><div id="diy4" class="area"><div id="frameMsd43L" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext" style="font-size:21px;margin-left:400px;color:rgb(0, 0, 255);"><a href="exam.php?mod=index&amp;action=index">开始录入考题</a></span></div><div id="frameMsd43L_left" class="column frame-1-c"><div id="frameMsd43L_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
