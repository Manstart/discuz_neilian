...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1508740231, '3', './data/template/3_3_common_header_misc_faq.tpl.php', './template/PHPChina', 'common/header_misc_faq')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1508740231, '3', './data/template/3_3_common_header_misc_faq.tpl.php', './template/PHPChina', 'common/header_misc_faq')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1508740231, '3', './data/template/3_3_common_header_misc_faq.tpl.php', './template/PHPChina', 'common/header_misc_faq')
;?>
