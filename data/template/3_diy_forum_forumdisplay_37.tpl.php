...
0
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_37.htm', './template/default/forum/forumdisplay_leftside.htm', 1508749088, 'diy', './data/template/3_diy_forum_forumdisplay_37.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_37')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_37.htm', './template/default/forum/recommend.htm', 1508749088, 'diy', './data/template/3_diy_forum_forumdisplay_37.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_37')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_37.htm', './template/default/common/seccheck.htm', 1508749088, 'diy', './data/template/3_diy_forum_forumdisplay_37.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_37')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_37.htm', './template/default/forum/forumdisplay_list.htm', 1508749088, 'diy', './data/template/3_diy_forum_forumdisplay_37.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_37')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_37.htm', './template/default/forum/forumdisplay_sort.htm', 1508749088, 'diy', './data/template/3_diy_forum_forumdisplay_37.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_37')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_37.htm', './template/default/forum/search_sortoption.htm', 1508749088, 'diy', './data/template/3_diy_forum_forumdisplay_37.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_37')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_37.htm', './template/default/forum/search_sortoption.htm', 1508749088, 'diy', './data/template/3_diy_forum_forumdisplay_37.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_37')
;
block_get('14,15,16,17,18,19,20,21,22');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_17 {  border:#0000ff !important;}#frameLyUw1d {  border:#0000ff !important;}</style>
...
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frame516621" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext" style="font-size:20px;">内联活动公告</span></div><div id="frame516621_left" class="column frame-1-c"><div id="frame516621_left_temp" class="move-span temp"></div><?php block_display('14');?><?php block_display('15');?><?php block_display('16');?><?php block_display('17');?><?php block_display('18');?><?php block_display('19');?><?php block_display('20');?><?php block_display('21');?><?php block_display('22');?></div></div><div id="framee3HCg5" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext" style="font-size:20px;">自助专区</span></div><div id="framee3HCg5_left" class="column frame-1-c"><div id="framee3HCg5_left_temp" class="move-span temp"></div></div></div><div id="frameLyUw1d" class=" frame move-span cl frame-1"><div class="title frame-title" style='background-image:none;background-repeat:repeat;background-color:rgb(255, 255, 255);'><span class="titletext" style="color:rgb(0, 0, 255);"><a href="../../../data/attachment/funds/funds.xlsx">下载经费明细</a></span><span class="subtitle" style="margin-left:100px;"><a href="funds.php?mod=index&amp;action=index" target="_blank" style="color:rgb(102, 102, 102) !important;">购买物资申请</a></span><span class="subtitle" style="margin-left:100px;"><a href="funds.php?mod=index&amp;action=funds_list" target="_blank" style="color:rgb(102, 102, 102) !important;">查看物资申请记录</a></span><span class="subtitle" style="margin-left:100px;"><a href="funds.php?mod=index&amp;action=index_per" target="_blank" style="color:rgb(102, 102, 102) !important;">个人使用物资申请</a></span><span class="subtitle" style="margin-left:100px;"><a href="funds.php?mod=index&amp;action=personal_list" target="_blank" style="color:rgb(102, 102, 102) !important;">个人使用物资申请记录</a></span></div><div id="frameLyUw1d_left" class="column frame-1-c"><div id="frameLyUw1d_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
<div class="boardnav">
