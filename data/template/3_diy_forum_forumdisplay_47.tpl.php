<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forumdisplay_47');
0
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_47.htm', './template/default/forum/forumdisplay_leftside.htm', 1508914991, 'diy', './data/template/3_diy_forum_forumdisplay_47.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_47')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_47.htm', './template/default/forum/recommend.htm', 1508914991, 'diy', './data/template/3_diy_forum_forumdisplay_47.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_47')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_47.htm', './template/default/common/seccheck.htm', 1508914991, 'diy', './data/template/3_diy_forum_forumdisplay_47.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_47')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_47.htm', './template/default/forum/forumdisplay_list.htm', 1508914991, 'diy', './data/template/3_diy_forum_forumdisplay_47.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_47')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_47.htm', './template/default/forum/forumdisplay_sort.htm', 1508914991, 'diy', './data/template/3_diy_forum_forumdisplay_47.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_47')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_47.htm', './template/default/forum/search_sortoption.htm', 1508914991, 'diy', './data/template/3_diy_forum_forumdisplay_47.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_47')
|| checktplrefresh('data/diy/./template/PHPChina//forum/forumdisplay_47.htm', './template/default/forum/search_sortoption.htm', 1508914991, 'diy', './data/template/3_diy_forum_forumdisplay_47.tpl.php', 'data/diy/./template/PHPChina/', 'forum/forumdisplay_47')
;
block_get('26');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<style id="diy_style" type="text/css"></style>
<!--[diy=diynavtop]--><div id="diynavtop" class="area"><div id="framex4Rnru" class=" frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="framex4Rnru_left" class="column frame-1-c"><div id="framex4Rnru_left_temp" class="move-span temp"></div><?php block_display('26');?></div></div></div><!--[/diy]-->
...
<!--[diy=diyfastposttop]--><div id="diyfastposttop" class="area"><div id="frame51x112" class="frame move-span cl frame-1"><div class="title frame-title" style='background-image:none;background-repeat:repeat;background-color:rgb(255, 255, 255);'><span class="titletext" style="color:rgb(0, 0, 255);">考题讨论专区</span></div><div id="frame51x112_left" class="column frame-1-c"><div id="frame51x112_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
