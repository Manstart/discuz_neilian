...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1508742426, '3', './data/template/3_3_common_header_funds_index.tpl.php', './template/PHPChina', 'common/header_funds_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1508742426, '3', './data/template/3_3_common_header_funds_index.tpl.php', './template/PHPChina', 'common/header_funds_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1508742426, '3', './data/template/3_3_common_header_funds_index.tpl.php', './template/PHPChina', 'common/header_funds_index')
;?>
