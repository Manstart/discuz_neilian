...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1506400770, '3', './data/template/3_3_common_header_forum_post.tpl.php', './template/PHPChina', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1506400770, '3', './data/template/3_3_common_header_forum_post.tpl.php', './template/PHPChina', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1506400770, '3', './data/template/3_3_common_header_forum_post.tpl.php', './template/PHPChina', 'common/header_forum_post')
;?>
