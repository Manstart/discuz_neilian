...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1506400758, '3', './data/template/3_3_common_header_forum_guide.tpl.php', './template/PHPChina', 'common/header_forum_guide')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1506400758, '3', './data/template/3_3_common_header_forum_guide.tpl.php', './template/PHPChina', 'common/header_forum_guide')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1506400758, '3', './data/template/3_3_common_header_forum_guide.tpl.php', './template/PHPChina', 'common/header_forum_guide')
;?>
