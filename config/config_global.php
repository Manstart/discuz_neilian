...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'pqb7_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '4ed82ae1b888239c3f433809f54165b0ZRjWQkmsC5nDwC7pdv';
...
$_config['plugindeveloper'] = 1;// 1 表示开启插件设计者模式 ； 2 表示开启插件设计者模式且显示前台页面的潜入点
