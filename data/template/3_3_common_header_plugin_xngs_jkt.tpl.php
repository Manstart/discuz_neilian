...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1508770587, '3', './data/template/3_3_common_header_plugin_xngs_jkt.tpl.php', './template/PHPChina', 'common/header_plugin_xngs_jkt')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1508770587, '3', './data/template/3_3_common_header_plugin_xngs_jkt.tpl.php', './template/PHPChina', 'common/header_plugin_xngs_jkt')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1508770587, '3', './data/template/3_3_common_header_plugin_xngs_jkt.tpl.php', './template/PHPChina', 'common/header_plugin_xngs_jkt')
;?>
