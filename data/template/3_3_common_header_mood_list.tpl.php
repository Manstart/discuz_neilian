...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1508756550, '3', './data/template/3_3_common_header_mood_list.tpl.php', './template/PHPChina', 'common/header_mood_list')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1508756550, '3', './data/template/3_3_common_header_mood_list.tpl.php', './template/PHPChina', 'common/header_mood_list')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1508756550, '3', './data/template/3_3_common_header_mood_list.tpl.php', './template/PHPChina', 'common/header_mood_list')
;?>
